...
実体化というのはただ頭のなかだけでなく、たとえば携帯端末のなかのメッセージとしてより形めいてあるような気がしています。

かつて電信が登場したときに、メッセージは物理的な形からいったん分離されたと言えます。

> メッセージとは物理的な実体であるように見られていたが、それは最初から幻想だった。今やメッセージの概念を、メッセージが書かれた紙片から意図的に切り離す必要があった。《ハーパーズ》誌の説明によれば、科学者は電流が「メッセージを"運ぶ"」というだろうが、その言い回しから、なんらかのものが－－なんらかの"もの"が－－輸送されるところを思い描いてはいけない。（ハーパーズ・ニュー・マンスリー・マガジン、1873年。「インフォメーション　情報技術の人類史」p.191 からの孫引き）

ここでメッセージを"運ぶ"という言い回しに注目したいと思います。高橋の「実体化」とは頭のなかで起こる掴んだような感覚ですし、機械に対する擬人的な言い回しも含め、情報とは見立てることなしに説明が難しいものだったかもしれません。しかし、電信の時代以降に「知る」や「知らせ」ということが圧倒的に膨らんで、これまでの何かに置き換えて見立てるしかなかった新しいものも、日常にあふれかえるようになりました。それはもう、いちいち手紙を参照することもなく、見立てを経由することもなく、また物理的な実体を伴うこともなく、とくには画面のなかであたりまえのように、ひとまとまりのかたちとして独自の存在感を備えているのではないでしょうか。

つまり、情報処理が親指の画面タッチですら行われる水準となったいまは、情報が《「知る」ということの実体化》であることに対して、暗黙的には含んでいたであろう《配置できるかたち》という属性を明示しておきたいと思います。

かたちの存在について、典型的には画面におけるウィンドウのような矩形表現を念頭に置いているのですが、この話はまた別の機会にしたいと思います。
